      ...
      <div className=" bg-[#1A2C24] bg-opacity-l70 text-white px-4 py-4 w-11/12 max-w-md rounded-lg shadow-lg">
        ...
        <div className="text-center flex flex-col items-center mb-6">
          ...
          <p className="text-xs text-gray-300 mb-8">
            ...
            <div className="bg-gray-100 mb-16 text-black w-24 h-24 flex items-center justify-center rounded-md cursor-pointer text-2xl font-bold">
              +
            </div>
